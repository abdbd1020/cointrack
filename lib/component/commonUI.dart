...
Widget noItemView(dynamic refreshCallback, String message) {
...
void showGeneralAlertDialog(
    { BuildContext context, double height,  List<Widget> children}) {
  showDialog(
      context: context,
                    ...
                    children: <Widget>[
                      TextFormField(
                        ...
                        decoration: new InputDecoration(
                          labelText: "Please specify the reason(Mandatory)",
